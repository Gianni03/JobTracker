  ...
  return (
    <div className="space-y-8">
        <div className="flex items-center gap-4">
            ...
            <div>
                <h1 className="text-3xl font-bold font-headline text-foreground">Editar Postulación</h1>
                <p className="text-muted-foreground">Actualiza la información de tu postulación a {application.company}</p>
            </div>
        </div>
